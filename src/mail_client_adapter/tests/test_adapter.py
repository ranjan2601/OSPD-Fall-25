...
from mail_client_service_client.mail_client_service_api_client.models.mark_read_response import (
    MarkReadResponse,
)
...
class TestServiceClient:
    ...
    @patch("mail_client_adapter._impl.get_message_messages_message_id_get")
    ...
    @patch("mail_client_adapter._impl.delete_message_messages_message_id_delete")
    ...
    @patch("mail_client_adapter._impl.mark_as_read_messages_message_id_read_put")
    ...
    @patch("mail_client_adapter._impl.get_messages_messages_get")
