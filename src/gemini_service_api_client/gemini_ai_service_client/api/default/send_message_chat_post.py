...
) -> Optional[Union[HTTPValidationError, SendMessageResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, SendMessageResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, SendMessageResponse]
    """
