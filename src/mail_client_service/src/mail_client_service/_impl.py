...
This module provides the ServiceClient class that implements the mail_client_api.Client
protocol by communicating with a FastAPI mail service over HTTP.

The implementation uses auto-generated client code to make HTTP requests and converts
the responses back to the protocol types expected by the mail client interface.
"""
