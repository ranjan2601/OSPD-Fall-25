...
# get_client factory doesn't exist in current implementation
...
# get_message factory doesn't exist in current implementation
...
# get_channel factory doesn't exist in current implementation
